    ...
    $.each(row, function (key, value) {
        switch (key) {
            case 'eventData':
                ...
                html.push(`<a class="btn btn-soft-primary" style="margin-bottom: 20px" href="/${currentLocale}/inventory/${itemId}">
    ...
    $.each(row, function (key, value) {
        switch (key) {
            case 'saleData':
                ...
                html.push('<p><small>Row: ' + row + '</p></small>');
                html.push('<p><small>Seats: ' + seatFrom + ' - ' + seatTo + '</p></small>');
                html.push(`<a class="btn btn-soft-info" style="margin-bottom: 20px" href="/${currentLocale}/events/${eventId}">
