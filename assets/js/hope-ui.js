...
-----------------------------------------------------------------------*/
if ($.fn.DataTable) {
  if ($('.initialize-table').length) {
    const table = $('.initialize-table').DataTable({
...
document.addEventListener("DOMContentLoaded", () => {
  const customSelects = document.querySelectorAll(".selectCustomInput");
  ...
  customSelects.forEach((select) => {
    select.addEventListener('change', function () {
      ...
      if (selectValue === 'customOption') {
        ...
        $('.customInput').focus();
        select.disabled = true; // Removed quotes around true
...
function hideInput() {
  ...
  if ($('.customInput').length) {
    ...
    customSelects.forEach((select) => {
      select.style.display = 'inline'; // Changed to 'inline'
