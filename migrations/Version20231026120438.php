 ...
 */
final class Version20231026120438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Roles (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(256) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Users (id INT AUTO_INCREMENT NOT NULL, captcha_provider_id INT DEFAULT NULL, first_name VARCHAR(256) DEFAULT NULL, last_name VARCHAR(256) NOT NULL, username VARCHAR(256) NOT NULL, password VARCHAR(256) NOT NULL, secret_code VARCHAR(256) DEFAULT NULL, license_key VARCHAR(64) DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, discord_id VARCHAR(20) DEFAULT NULL, discord_username VARCHAR(32) DEFAULT NULL, image_url VARCHAR(256) DEFAULT NULL, connections JSON DEFAULT NULL, about VARCHAR(160) DEFAULT NULL, currency VARCHAR(10) DEFAULT \'EUR\' NOT NULL, captcha_provider_api_key VARCHAR(256) DEFAULT NULL, INDEX fk_captcha_provider_id (captcha_provider_id), UNIQUE INDEX username (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
